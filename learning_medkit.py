...
model_savefile = "./model-doom_medkit.pth"
save_model = True
load_model = False
skip_learning = False
...
class DuelQNet(nn.Module):
    ...
    def __init__(self, available_actions_count):
        ...
        self.advantage_fc = nn.Sequential(
                nn.Linear(96, 800), nn.ReLU(), nn.Linear(800, available_actions_count)
        )
...
if __name__ == "__main__":
    ...
    if not skip_learning:
        ...
        agent_object = agent
        file_agent = open("file_agent_escenario-2.obj", "wb")
        pickle.dump(agent_object, file_agent)
    ...
    for _ in range(episodes_to_watch):
        ...
        data_agent_score.append( score )

        print("Total score: ", score)

    plt.plot( data_agent_score, color="green" )
